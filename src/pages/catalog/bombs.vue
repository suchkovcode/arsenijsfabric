<template>
   <section class="pb-10 pt-28 lg:pb-14 lg:pt-36 xl:pb-16">
      <div class="container">
         <v-breadcrumbs class="mb-8 lg:mb-12 xl:mb-16" :roter-link="{ catalog: true, name: 'Bombs', to: '/catalog/bombs' }" />
         <div class="mb-5 flex flex-col items-center lg:mb-10 lg:flex-row lg:justify-between">
            <h1
               ...
               <svg class="absolute -top-5 left-1/2 h-9 w-24 -translate-x-1/2 lg:left-11 lg:translate-x-0" fill="none">
                  <use xlink:href="/img/sprite.svg#indexTitleIcon-8"></use>
               </svg>
               Bombs
            </h1>
         ...
         <app-catalog class="" :data-item="store.products" />
      </div>
   </section>
</template>
